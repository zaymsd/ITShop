...
<div x-data="{ openModal: @entangle('showSaveModal') }">
    {{-- ── Page Header ───────────────────────────────────────────────────────── --}}
    <div class="mb-6">
        <h1 class="text-heading-lg text-ink">Tambah Pengguna</h1>
        <p class="text-body-md text-mute">Buat akun admin atau petugas baru</p>
    </div>
        ...
        <form wire:submit.prevent="confirmSave" class="space-y-6">
            ...
            <div>
                ...
                <div x-data="{ showPw: false }" class="relative">
                    <input wire:model="password" :type="showPw ? 'text' : 'password'" placeholder="Minimal 8 karakter"
    ...
    <div x-show="openModal"
        ...
        <div x-show="openModal"
            ...
            <h3 class="text-heading-lg text-ink mb-2">Simpan Pengguna?</h3>
            <p class="text-body-md text-body mb-8">
                Apakah Anda yakin ingin menyimpan pengguna baru ini ke database?
            </p>

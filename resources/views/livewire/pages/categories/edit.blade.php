...
<div x-data="{ openModal: @entangle('showUpdateModal') }">
    {{-- ── Page Header ───────────────────────────────────────────────────────── --}}
    <div class="mb-6">
        <h1 class="text-heading-lg text-ink">Edit Kategori</h1>
        <p class="text-body-md text-mute">Ubah data kategori produk</p>
    </div>
    ...
    <div class="max-w-2xl bg-surface-card rounded-[24px] p-8 border border-hairline">
        <form wire:submit.prevent="confirmUpdate" class="space-y-6">
            ...
            <p class="text-xs font-semibold text-mute">
                Slug akan di-update otomatis sesuai nama kategori saat disimpan.
            </p>

...
new #[Layout('layouts.app')] class extends Component {
    ...
    public function render(): \Illuminate\View\View
    {
        ...
        return view('livewire.pages.categories.index', compact('categories'));
    }
...
<div class="relative min-h-[80vh]">
    ...
    @if (session()->has('success'))
        <div x-data="{ show: true }"
            ...
            <button @click="show = false" class="text-[var(--color-success-text)] hover:opacity-70 transition-opacity">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-heading-lg text-ink">Kategori Produk</h1>
            <p class="text-body-md text-mute">Kelola kategori produk toko</p>
        </div>
    </div>
            ...
            <table class="w-full text-sm text-left">
                <thead class="bg-surface-soft border-b border-hairline">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-xs font-bold text-mute uppercase tracking-wider">Nama Kategori</th>
                        <th class="px-6 py-4 text-xs font-bold text-mute uppercase tracking-wider">Deskripsi</th>
                    ...
                    @forelse ($categories as $item)
                        <tr class="hover:bg-surface-soft transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-mute font-mono mt-0.5">{{ $item->slug }}</div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('categories.edit', $item->id) }}" wire:navigate
                                       title="Edit"
    ...
    <div x-data="{ open: @entangle('showDeleteModal') }"
        ...
        <div x-show="open"
            ...
            <h3 class="text-heading-lg text-ink mb-2">Hapus Kategori?</h3>
            <p class="text-body-md text-body mb-8">
                Tindakan ini tidak dapat dibatalkan. Data kategori akan dihapus permanen.
            </p>

...
new #[Layout('layouts.app')] class extends Component {
    ...
    {
        Brand::findOrFail($this->id)->update(['name' => $this->name]);
...
<div x-data="{ openModal: @entangle('showUpdateModal') }">
    {{-- ── Page Header ───────────────────────────────────────────────────────── --}}
    <div class="mb-6">
        <h1 class="text-heading-lg text-ink">Edit Brand</h1>
        <p class="text-body-md text-mute">Ubah data brand / merek produk</p>
    </div>
